...
<link type="text/css" rel="stylesheet" href="http://fast.fonts.com/cssapi/f020b0f1-bbb8-44cf-bd4f-eeb8385af57a.css"/>
  ...
  <div class="header-holder"> 
    ...
    <div class="header-right"> 
      ...
      <div id="top-right-ad-btn">
      	...
      	<a href="http://rmacl.org/news-events/run-walkn-roll-fundraiser-2016/"></a>
  ...
  <div class="grid_4 smallrow rightside home-sharing">
    ...
    <div class="heading-fp wide ">
      ...
      <h3>
      	...
      	<a 	href="/join-our-team/home-support/" 

      		title="<?php echo get_the_title(106); ?>">
      ...
      <div class="img-frame">
      	...
      	<a href="<?php echo get_permalink(106); ?>" title="<?php echo get_the_title(106); ?>">

      		<img src="<?php /* bloginfo( 'template_directory' ); */ ?>http://rmacl.org/rmacl/wp-content/uploads/image1.jpg" alt="<?php echo get_the_title(106); ?>"
